      ...
      return Scaffold(
          ...
          body: SnappingSheet(
            onSheetMoved: (sheetPosition) {
              // SlidingSheet'in durumunu dinleyerek AppBar'ın opaklık değerini güncelle
              setState(() {
                _appBarColor = Color.lerp(
                  Colors.blue, // Başlangıç rengi
                  Colors.white, // Hedef renk
                  sheetPosition.pixels / MediaQuery.of(context).size.height, // pixel değerini orantılı olarak kullan
                );
              });
            },
